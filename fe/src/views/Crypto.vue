...
const generateKLineData = () => {
  const basePrice = 5000 + Math.random() * 50000;
  const days = 30;
  const categoryData = [];
  const values = [];
  ...
  <div class="min-h-screen w-full bg-gray-50">
    ...
    <div class="mx-auto max-w-6xl space-y-10 p-6">
      ...
      <p class="text-gray-500">
        Browse, search, and trade your favorite crypto
      </p>
      ...
      <div class="sticky top-16 z-10 flex gap-3 rounded-lg bg-white p-4 shadow">
        <input
          v-model="searchInput"
          type="text"
          placeholder="Enter crypto name or code"
            ...
            <Table class="w-full">
              <TableHeader>
                <TableRow class="bg-gray-100">
                  <TableHead>Crypto Code</TableHead>
      ...
      <Card>
        <CardContent>
          <h2 class="mb-4 text-xl font-bold text-gray-800">Available Crypto</h2>
          <Table class="w-full">
            <TableHeader>
              <TableRow class="bg-gray-100">
